            ...
            >
                <View style={{
                    ...
                    >
                        ...
                        <Text style={{ fontSize: calculateFontSizePercentage(3), fontWeight: "600", color: "grey", textAlign: 'center' }}>Attendance</Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <Text style={{ fontSize: calculateFontSizePercentage(3), fontWeight: "600", color: "grey" }}>Target</Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <Text style={{ fontSize: calculateFontSizePercentage(3), fontWeight: "600", color: "grey" }}>Salary</Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <Text style={{ fontSize: calculateFontSizePercentage(3), fontWeight: "600", color: "grey" }}>Leave</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
